...
.btn:active {
  ...
  box-shadow: none;
	...
	<form action="/tasksassegnati/modificatasksassegnatid" method="get">
	<div class="main-form">
	          <h1 align="center">Dettagli del Task <%= d.getTitolo() %></h1>
			<input type="hidden" name="id" value="<%= t.getId() %>" readonly>
			 <input type="hidden" name="scadenza" value="<%= t.getScadenza() %>"><br>
	...
	<a href="/dipendenti/dettaglid?id=<%= d.getId() %>"> <button class="btn" role="button">ANNULLA</button></a>
	</body>
</html>